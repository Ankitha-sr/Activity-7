                                 ...
                                 margin = 50)
{
    ...
    function brushStart() {
        ...
        if (d3.brushSelection(this)[0][0] === d3.brushSelection(this)[1][0]) {
            ...
            ////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////
            // Missing Part 4 - SOLUTION: Remove selected class from all circles
            ////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    // Missing Part 5 - SOLUTION: Add legend click interaction
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
        .on("click", function(event, d) {
            // Toggle the legendSelect class on the clicked legend item
            const isSelected = d3.select(this).classed("legendSelect");
            d3.select(this).classed("legendSelect", !isSelected);
            
            // Toggle the legendSelect class on corresponding circles
            d3.selectAll(`circle.${d}`).classed("legendSelect", !isSelected);
        });
